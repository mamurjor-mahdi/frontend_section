...
<div class="row">
    <div class="col-md-12">
        <div class="card-header form-header">
            <h4 class="card-title text-center">Counter Table</h4>
        </div>
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="card-title">{{ $title }}</div>
                <div>
                    <a href="{{ route('admin.counter.create') }}" class="btn btn-lg btn-primary">Add Form</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @endphp
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="{{ route('admin.counter.edit',$value->id) }}" class="btn btn-sm btn-primary mr-1"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <form action="{{ route('admin.counter.delete',$value->id) }}" id="delete-form-{{ $value->id }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                    </form>
