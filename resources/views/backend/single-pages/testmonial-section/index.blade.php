...
<div class="row">
    <div class="col-md-12">
        <div class="card-header">
            <h4 class="card-title text-center">Testmonial Table</h4>
        </div>
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="card-title">{{ $title }}</div>
                <div>
                    <a href="{{ route('admin.testmonial.create') }}" class="btn btn-lg btn-primary">Add Form</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @endphp
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="{{ route('admin.testmonial.edit',$value->id) }}" class="btn btn-sm btn-primary mr-1"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <form action="{{ route('admin.testmonial.delete',$value->id) }}" id="delete-form-{{ $value->id }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('DELETE')
                                    </form>
