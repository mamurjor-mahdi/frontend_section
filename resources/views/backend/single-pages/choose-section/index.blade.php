    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <div>
                    <a href="{{ route('admin.choose.create') }}" class="btn btn-lg btn-primary">Add Form</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @endphp
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="{{ route('admin.choose.edit',$value->id) }}" class="btn btn-sm btn-primary mr-1"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <form action="{{ route('admin.choose.delete',$value->id) }}" id="delete-form-{{ $value->id }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                    </form>
